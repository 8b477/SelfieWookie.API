...
namespace SelfieWookie.API.UI.Controllers
{
    ...
    public class SelfieController : ControllerBase
    {
        ...
        public IActionResult AddOne(SelfieDto model)
        {
            ...
            SelfieDto newDto = new SelfieDto() { Title = model.Title };
        ...
        //Ici je récupère un Wookie via son ID
        [HttpGet]
        [Route("GetByIdWookie")]
        ...
        //Ici je récupère un model resumeDto sur base d'un ID récupérer par Query
        [HttpGet]
        [Route("GetByIdSelfieResumeDto")]
        public IActionResult testByID([FromQuery] int id = 0)
        {
